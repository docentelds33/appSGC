...
import co.com.app.modelo.Detalleventa;
import co.com.app.controlador.util.JsfUtil;
import co.com.app.controlador.util.JsfUtil.PersistAction;
...
public class DetalleventaController implements Serializable {
    ...
    @EJB
    private co.com.app.controlador.DetalleventaFacade ejbFacade;
